...
static const struct snd_kcontrol_new ak4642_speaker_control =
	SOC_DAPM_SINGLE("Switch", SG_SL1, 7, 1, 0);
...
static const struct snd_soc_dapm_widget ak4642_dapm_widgets[] = {
	...
	SND_SOC_DAPM_PGA("SPK Out", PW_MGMT1, 4, 0, NULL, 0),

	SND_SOC_DAPM_SWITCH("Speaker Enable", SND_SOC_NOPM, 0, 0,
			    &ak4642_speaker_control),


	SND_SOC_DAPM_PGA("DACH", MD_CTL4, 0, 0, NULL, 0),
	SND_SOC_DAPM_PGA("DACS", SG_SL1, 5, 0, NULL, 0),
...
static const struct snd_soc_dapm_route ak4642_intercon[] = {
	...
	{"SPK Out", NULL, "Speaker Enable"},

	{"Headphone Enable", "Switch", "DACH"},
	{"Speaker Enable", "Switch", "DACS"},
